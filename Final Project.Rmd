...
```{r, message=FALSE, fig.width=7.5, echo=FALSE, warning=FALSE}
# Create hover text
...
```{r, message=FALSE, fig.width=7, echo=FALSE, warning=FALSE}
subplot(caseline, deathline, nrows = 2, margin = .05)
```
